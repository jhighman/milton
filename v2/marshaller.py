...
def check_cache_or_fetch(
    ...
    cache_path.mkdir(parents=True, exist_ok=True)  # Ensure directory exists before fetch

    # Check cache using service-specific manifest
    ...
    # Cache results (even if empty) and write manifest
...
SELENIUM_AGENTS = {"SEC_Arbitration_Agent", "NFA_Basic_Agent", "FINRA_Arbitration_Agent"}  # Removed FINRA_Disciplinary_Agent
...
def main():
    ...
    try:
        ...
        # 6. FINRA Disciplinary Agent - search_individual (non-Selenium assumed due to error)
