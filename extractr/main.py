...
def process_csv(csv_file_path, start_line):
    ...
    with open(csv_file_path, 'r') as csvfile:
        ...
        for index, row in enumerate(records):
            ...
            try:
                # Use ApiClient to get individual basic and detailed info from BrokerCheck
                ...
                # Use ApiClient to get individual basic and detailed info from SEC
            ...
            # Determine whether to use BrokerCheck or SEC data
            if basic_info and basic_info.get('hits', {}).get('hits', []):
                # Use BrokerCheck data
                log_diagnostic(f"Using BrokerCheck data for CRD {crd_number}.")
                ...
                # Use SEC data if BrokerCheck data is unavailable
                log_diagnostic(f"Using SEC data for CRD {crd_number} as BrokerCheck data is unavailable.")
            ...
            # Now proceed with the evaluation using the selected data source
