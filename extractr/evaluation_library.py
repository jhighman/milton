...
def evaluate_registration_status(individual_info: Dict[str, Any]) -> Tuple[bool, List[Alert]]:
    ...
    Args:
        individual_info (Dict[str, Any]): The individual's information retrieved from the API.

    Returns:
        Tuple[bool, List[Alert]]: A tuple containing a boolean indicating if the status is okay,
        and a list of generated alerts.
    """
...
def evaluate_disclosures(disclosures: List[Dict[str, Any]], name: str) -> Tuple[List[Alert], Optional[str]]:
    ...
    Args:
        disclosures (List[Dict[str, Any]]): A list of disclosures from the individual's detailed information.
        name (str): The individual's name.

    Returns:
        Tuple[List[Alert], Optional[str]]: A list of alerts generated from disclosures,
        and a summary string if there are any disclosures.
    """
    alerts = []
    disclosure_counts = {}
